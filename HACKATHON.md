# x402 Banana Playground - MNEE Hackathon Submission

> **AI & Agent Payments Track**  
> Autonomous AI agents paying for image generation services with MNEE stablecoin

## 🎯 Project Overview

x402 Banana Playground is an AI-powered image generation platform that enables both humans and AI agents to autonomously pay for services using MNEE stablecoin on Ethereum. This project demonstrates programmable money in action, where AI agents can independently transact without human intervention.
...
- One-time use payment validation
...
```typescript
import { Contract, parseUnits } from 'viem'
...
async function generateImage(prompt: string) {
  ...
  const tx = await mneeContract.transfer(
    TREASURY,
    parseUnits('0.15', 6) // MNEE has 6 decimals
  )
  await tx.wait()
...
✅ **Uses MNEE Stablecoin**: All payments use MNEE token on Ethereum  
✅ **AI & Agent Payments Track**: Agents autonomously pay for services  
✅ **Smart Contract Integration**: Direct interaction with MNEE ERC20 contract  
✅ **Real Utility**: Functional image generation service  
✅ **Production Ready**: Full error handling, security, and monitoring  

## 🌟 Innovation Highlights

1. **Dual Interface**: Both humans and agents can use the same service
2. **Autonomous Payments**: Agents handle payment → service flow independently
3. **Payment Verification**: Secure on-chain validation without central authority
4. **Developer Experience**: Simple REST API for easy agent integration
5. **Scalable Architecture**: Ready for production deployment

## 📚 API Documentation

Full documentation available at `/agent/docs` or see inline examples above.
...
- **Live App**: [Deploy to Vercel/Netlify]
- **Agent Dashboard**: `{your-url}/agent/dashboard`
...
- MNEE Team for the hackathon and stablecoin
...
- **Built with**: Next.js, MNEE, viem, Supabase
